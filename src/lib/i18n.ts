export const fa = {
  ...
  parts: {
    ...
    blurb: 'خروجی چندپارچه است: فایل .zip به‌همراه .z01 و .z02 و … (همان الگوی zip -s).',
    fileLabel: 'نام خروجی:',
    howTitle: 'بعد از دانلود',
    step1: 'همهٔ فایل‌ها را با همان نام در یک پوشه ذخیره کنید (.zip و .z01 و …)',
    step2: 'در WinRAR یا ۷-زیپ روی فایل .zip دوبارکلیک کنید؛ بقیهٔ قطعات خودکار وصل می‌شوند',
    step3: 'پس از استخراج، ویدیو یا صوت را پخش کنید.',
    close: 'بستن',
